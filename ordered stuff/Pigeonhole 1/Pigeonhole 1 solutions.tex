...
In latter case, we take two pairs of numbers with pairwise identical 'footprints' and it is enough for sums of powers to be even, therefore giving us the numbrs we were looking for. 
\end{problem}
\filbreak
